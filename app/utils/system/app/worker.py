...
def return_file(inputs):
    ...
    if klines_ok:
        ...
        if file_format == 'csv':
            ...
            stock.to_csv('static/cryptodata/' + filename_, index = False)
            
        elif file_format == 'excel':
            filename_ = symbol + '_' + interval + '_' + start + '_' + end + '.xlsx'
            stock.to_excel('static/cryptodata/' + filename_, index = False)
        
        print('Done.')
        return('/cryptodata/' + filename_)
